...
- why would one favor this style of integration?
  - Aligned with the design pattern of integrations like dbt, dlt, and sling
  - Fits into the overall design pattern of Dagster, where many objects are created through the use of decorated functions.
  - pros/cons
- overview
  - structure
- tldr of writing a decorator
  - Before we begin, let's walk through how one would create a decorator in Python
- walkthrough of creating a custom YAML-backed multi-asset
- alternatives
  - builder / factory methods

# Approaches to writing integrations in Dagster
